!function(t, n) {
    ...
    "use strict";
    function n(t) {
        return 10 === t || 13 === t || 8232 === t || 8233 === t || 32 === t || 9 === t || 11 === t || 12 === t || 160 === t || t >= 5760 && hn.indexOf(t) >= 0
    }
    function e(t) {
        switch (32 | t) {
        case 109:
    ...
    function s(t) {
        ...
        if (i >= a)
            return void (t.err = "SvgPath: missed param (at pos " + i + ")");
        if (n = t.path.charCodeAt(i),
        43 !== n && 45 !== n || (i++,
        n = i < a ? t.path.charCodeAt(i) : 0),
        !r(n) && 46 !== n)
            return void (t.err = "SvgPath: param should start with 0..9 or `.` (at pos " + i + ")");
        if (46 !== n) {
            if (o = 48 === n,
            i++,
            n = i < a ? t.path.charCodeAt(i) : 0,
            o && i < a && n && r(n))
                return void (t.err = "SvgPath: numbers started with `0` such as `09` are ilegal (at pos " + e + ")");
        ...
        if (101 === n || 69 === n) {
            ...
            n = i < a ? t.path.charCodeAt(i) : 0,
            43 !== n && 45 !== n || i++,
            !(i < a && r(t.path.charCodeAt(i))))
                return void (t.err = "SvgPath: invalid float exponent (at pos " + i + ")");
            for (; i < a && r(t.path.charCodeAt(i)); )
                i++
        }
        t.index = i,
        t.param = parseFloat(t.path.slice(e, i)) + 0
    }
    function h(t) {
        var n, e;
        n = t.path[t.segmentStart],
        e = n.toLowerCase();
        var r = t.data;
        if ("m" === e && r.length > 2 && (t.result.push([n, r[0], r[1]]),
        r = r.slice(2),
        e = "l",
        n = "m" === n ? "l" : "L"),
        "r" === e)
            t.result.push([n].concat(r));
        else
            for (; r.length >= sn[e] && (t.result.push([n].concat(r.splice(0, sn[e]))),
            sn[e]); )
                ;
    }
    function u(t) {
        ...
        for (r = !1; ; ) {
            for (u = a; u > 0; u--) {
                ...
                o(t),
                r = !1,
                t.index < c && 44 === t.path.charCodeAt(t.index) && (t.index++,
                o(t),
                r = !0)
            }
            if (!r) {
                if (t.index >= t.max)
                    break;
                if (!i(t.path.charCodeAt(t.index)))
                    break
            }
        }
        h(t)
    ...
    function d(t, n, e, r, i, a, o, s) {
        ...
        null !== o && void 0 !== o && null !== s && void 0 !== s ? (this.getArcLength = _,
        this.getPoint = L,
        this.getDerivative = M) : (this.getArcLength = A,
        this.getPoint = b,
    ...
    function A(t, n, e) {
        ...
        var r = t[0] - 2 * t[1] + t[2]
          ...
          , u = a * a + o * o;
        if (0 === s)
            return e * Math.sqrt(Math.pow(t[2] - t[0], 2) + Math.pow(n[2] - n[0], 2));
        var c = h / (2 * s)
          , f = u / s
          , l = e + c
          , p = f - c * c;
    ...
    function Z(t, n, e, r, i, a, o, s, h) {
        var u = 0
          , c = []
          , f = [];
        Sn(t, n, e, r, i, a, o, s, h).forEach(function(t) {
            var n = new qn(t[0],t[1],t[2],t[3],t[4],t[5],t[6],t[7])
              , e = n.getTotalLength();
            u += e,
            c.push(e),
            f.push(n)
    ...
    function Y(t) {
        return G(t) ? an(t) : [(t[0][0] + t[t.length - 1][0]) / 2, (t[0][1] + t[t.length - 1][1]) / 2]
    }
    function G(t) {
        for (var n = 0; n < t.length - 2; n++) {
            var e = t[n]
              , r = t[n + 1]
              , i = t[n + 2];
            if (e[0] * (r[1] - i[1]) + r[0] * (i[1] - e[1]) + i[0] * (e[1] - r[1]))
                return !0
        }
        return !1
    }
    ...
    function R(t, n) {
        ...
        r = B(i),
        e = r.getTotalLength(),
        n && X(n) && n > 0 && (o = Math.max(o, Math.ceil(e / n)));
        for (var s = 0; s < o; s++) {
    ...
    function B(t) {
        if ("undefined" != typeof window && window && window.document)
            try {
                ...
                return n.setAttributeNS(null, "d", t),
                n
            } catch (t) {}
        return Tn(t)
    }
    function W(t, n) {
        for (var e = t.length + n, r = on(t) / n, i = 0, a = 0, o = r / 2; t.length < e; ) {
            var s = t[i]
              , h = t[(i + 1) % t.length]
              , u = F(s, h);
            o <= a + u ? (t.splice(i + 1, 0, u ? z(s, h, (o - a) / u) : s.slice(0)),
            o += r) : (a += u,
            i++)
        }
    }
    ...
    function J(t, n) {
        ...
        !K(e))
            throw new TypeError(Fn);
        return e.length > 1 && j(e[0], e[e.length - 1]) && e.pop(),
        r = rn(e),
        r > 0 && e.reverse(),
        !i && n && X(n) && n > 0 && $(e, n),
        e
    ...
    function rt(t, n) {
        ...
        do {
            if (e = !1,
            r.steiner || !wt(r, r.next) && 0 !== Mt(r.prev, r, r.next))
                r = r.next;
            else {
                if (St(r),
                (r = n = r.prev) === r.next)
        ...
        if (t) {
            ...
            for (var s, h, u = t; t.prev !== t.next; )
                ...
                a ? ot(t, r, i, a) : at(t))
                    ...
                    o ? 1 === o ? (t = st(rt(t), n, e),
                    it(t, n, e, r, i, a, 2)) : 2 === o && ht(t, n, e, r, i, a) : it(rt(t), n, e, r, i, a, 1);
                    break
                }
        }
    }
    function at(t) {
        ...
        for (var i = t.next.next; i !== t.prev; ) {
            if (dt(n.x, n.y, e.x, e.y, r.x, r.y, i.x, i.y) && Mt(i.prev, i, i.next) >= 0)
                return !1;
            i = i.next
        }
        return !0
    ...
    function ot(t, n, e, r) {
        ...
        if (Mt(i, a, o) >= 0)
            return !1;
        for (var s = i.x < a.x ? i.x < o.x ? i.x : o.x : a.x < o.x ? a.x : o.x, h = i.y < a.y ? i.y < o.y ? i.y : o.y : a.y < o.y ? a.y : o.y, u = i.x > a.x ? i.x > o.x ? i.x : o.x : a.x > o.x ? a.x : o.x, c = i.y > a.y ? i.y > o.y ? i.y : o.y : a.y > o.y ? a.y : o.y, f = xt(s, h, n, e, r), l = xt(u, c, n, e, r), p = t.prevZ, v = t.nextZ; p && p.z >= f && v && v.z <= l; ) {
            if (p !== t.prev && p !== t.next && dt(i.x, i.y, a.x, a.y, o.x, o.y, p.x, p.y) && Mt(p.prev, p, p.next) >= 0)
                return !1;
            if (p = p.prevZ,
            v !== t.prev && v !== t.next && dt(i.x, i.y, a.x, a.y, o.x, o.y, v.x, v.y) && Mt(v.prev, v, v.next) >= 0)
                return !1;
            v = v.nextZ
        }
        for (; p && p.z >= f; ) {
        ...
        for (; v && v.z <= l; ) {
            if (v !== t.prev && v !== t.next && dt(i.x, i.y, a.x, a.y, o.x, o.y, v.x, v.y) && Mt(v.prev, v, v.next) >= 0)
                return !1;
            v = v.nextZ
        }
        return !0
    ...
    function st(t, n, e) {
        ...
        do {
            var i = r.prev
              , a = r.next.next;
            !wt(i, a) && bt(i, r, r.next, a) && kt(i, a) && kt(a, i) && (n.push(i.i / e),
            n.push(r.i / e),
            n.push(a.i / e),
            St(r),
            St(r.next),
    ...
    function lt(t, n) {
        ...
        r = e;
        do {
            i >= r.x && r.x >= c && i !== r.x && dt(a < f ? i : o, a, c, f, a < f ? o : i, a, r.x, r.y) && (h = Math.abs(a - r.y) / (i - r.x),
            kt(r, t) && (h < l || h === l && (r.x > e.x || r.x === e.x && pt(e, r))) && (e = r,
            l = h)),
            r = r.next
        } while (r !== u);return e
    }
    function pt(t, n) {
        return Mt(t.prev, t, n.prev) < 0 && Mt(n.next, t, t.next) < 0
    }
    function vt(t, n, e, r) {
        var i = t;
        do {
            null === i.z && (i.z = xt(i.x, i.y, n, e, r)),
            i.prevZ = i.prev,
            i.nextZ = i.next,
            i = i.next
    ...
    function yt(t) {
        var n = t
          , e = t;
        do {
            (n.x < e.x || n.x === e.x && n.y < e.y) && (e = n),
            n = n.next
        } while (n !== t);return e
    }
    function dt(t, n, e, r, i, a, o, s) {
        return (i - o) * (n - s) - (t - o) * (a - s) >= 0 && (t - o) * (r - s) - (e - o) * (n - s) >= 0 && (e - o) * (a - s) - (i - o) * (r - s) >= 0
    }
    function mt(t, n) {
        return t.next.i !== n.i && t.prev.i !== n.i && !qt(t, n) && (kt(t, n) && kt(n, t) && Pt(t, n) && (Mt(t.prev, t, n.prev) || Mt(t, n.prev, n)) || wt(t, n) && Mt(t.prev, t, t.next) > 0 && Mt(n.prev, n, n.next) > 0)
    }
    function Mt(t, n, e) {
    ...
    function bt(t, n, e, r) {
        var i = At(Mt(t, n, e))
          ...
          , o = At(Mt(e, r, t))
          , s = At(Mt(e, r, n));
        return i !== a && o !== s || (!(0 !== i || !Lt(t, e, n)) || (!(0 !== a || !Lt(t, r, n)) || (!(0 !== o || !Lt(e, t, r)) || !(0 !== s || !Lt(e, n, r)))))
    }
    function Lt(t, n, e) {
    ...
    function Pt(t, n) {
        var e = t
          ...
          , a = (t.y + n.y) / 2;
        do {
            e.y > a != e.next.y > a && e.next.y !== e.y && i < (e.next.x - e.x) * (a - e.y) / (e.next.y - e.y) + e.x && (r = !r),
            e = e.next
        } while (e !== t);return r
    }
    function _t(t, n) {
        var e = new Ct(t.i,t.x,t.y)
          , r = new Ct(n.i,n.x,n.y)
          , i = t.next
          , a = n.prev;
        return t.next = n,
        n.prev = t,
    ...
    function Vt(t, n) {
        ...
        return t.forEach(function(t) {
            ...
            r.objects.triangles.geometries.push({
                type: "Polygon",
                area: Math.abs(rn(t.map(function(t) {
                    return n[t[0]]
                }))),
                arcs: [i]
            })
    ...
    function Xt(t, n) {
        for (var e = t.objects.triangles.geometries, r = Rn(function(t) {
            return t.area
        }).left; e.length > n; )
            !function() {
                var n = e[0]
                  ...
                  , a = e[i]
                  , o = jt(t, [n, a]);
                o.area = n.area + a.area,
                o.type = "Polygon",
                o.arcs = o.arcs[0],
                e.splice(i, 1),
                e.shift(),
                e.splice(r(e, o.area), 0, o)
            }();
        if (n > e.length)
            throw new RangeError("Can't collapse topology into " + n + " pieces.");
        return Dn(t, t.objects.triangles).features.map(function(t) {
            return t.geometry.coordinates[0].pop(),
            t.geometry.coordinates[0]
        })
    }
    function Yt(t) {
        for (var n = Vn(t.reduce(function(t, n) {
    ...
    function Gt(t, n, e) {
        function r(t, n, o) {
            ...
            for (var s = 0; s < t.length; s++) {
                var h = t.splice(s, 1)
                  , u = e[h[0]][n.length];
                o + u < i && (t.length ? r(t.slice(), n.concat(h), o + u) : (i = o + u,
                a = n.concat(h))),
                t.length && t.splice(s, 0, h[0])
            }
        }
        var i = 1 / 0
    ...
    function Dt(t, n, e) {
        ...
        var s, h = Wn(o, n.length), u = n.map(function(t) {
            return J(t, r)
        }), c = "string" == typeof t && t;
    ...
    function Nt(t, n, e) {
        ...
        var a = e.single;
        if (void 0 === a && (a = !1),
        !Array.isArray(t) || !Array.isArray(n) || t.length !== n.length || !t.length)
    ...
    function Ut(t, n, e, r, i) {
        return $t(Jt(t, n, e), r, nn(t, n, e), 2 * Math.PI * e, i)
    }
    ...
    function Bt(t, n, e, r, i, a) {
        return $t(Kt(t, n, e, r), i, en(t, n, e, r), 2 * e + 2 * r, a)
    }
    function Wt(t, n, e, r, i, a) {
        var o = Bt(n, e, r, i, t, a);
        return function(t) {
            return o(1 - t)
        }
    }
    function $t(t, n, e, r, i) {
        ...
        void 0 === o && (o = !0);
        var s, h, u = J(n, a);
        return X(r) && u.length < r / a && W(u, Math.ceil(r / a - u.length)),
        s = t(u),
        h = I(s, u, o),
        o ? function(t) {
            return t < 1e-4 ? e : h(t)
    ...
    function Jt(t, n, e) {
        return function(r) {
            ...
            return r.map(function(i, h) {
                var u;
                return h && (s += F(i, r[h - 1])),
                u = o + 2 * Math.PI * (a ? s / a : h / r.length),
                [Math.cos(u) * e + t, Math.sin(u) * e + n]
            })
        }
    }
    function Kt(t, n, e, r) {
    ...
    var rn = function(t) {
      ...
      , hn = [5760, 6158, 8192, 8193, 8194, 8195, 8196, 8197, 8198, 8199, 8200, 8201, 8202, 8239, 8287, 12288, 65279]
      , un = function(t) {
        var n = new a(t)
          , e = n.max;
        for (o(n); n.index < e && !n.err.length; )
            u(n);
        return n.err.length ? n.result = [] : n.result.length && ("mM".indexOf(n.result[0][0]) < 0 ? (n.err = "SvgPath: string should start with `M` or `m`",
        n.result = []) : n.result[0][0] = "M"),
        {
            err: n.err,
            segments: n.result
        }
    ...
    f.prototype.matrix = function(t) {
        return 1 === t[0] && 0 === t[1] && 0 === t[2] && 1 === t[3] && 0 === t[4] && 0 === t[5] ? this : (this.cache = null,
        this.queue.push(t),
        this)
    }
    ,
    f.prototype.translate = function(t, n) {
        return 0 === t && 0 === n || (this.cache = null,
        this.queue.push([1, 0, 0, 1, t, n])),
        this
    }
    ,
    f.prototype.scale = function(t, n) {
        return 1 === t && 1 === n || (this.cache = null,
        this.queue.push([t, 0, 0, n, 0, 0])),
        this
    }
    ,
    f.prototype.rotate = function(t, n, e) {
        var r, i, a;
        return 0 !== t && (this.translate(n, e),
        r = t * Math.PI / 180,
        i = Math.cos(r),
        a = Math.sin(r),
    ...
    f.prototype.calc = function(t, n, e) {
        ...
        r = this.cache,
        [t * r[0] + n * r[2] + (e ? 0 : r[4]), t * r[1] + n * r[3] + (e ? 0 : r[5])]) : [t, n]
    }
    ;
    var cn = f
      , fn = {
      ...
      , ln = /\s*(matrix|translate|scale|rotate|skewX|skewY)\s*\(\s*(.+?)\s*\)[\s,]*/
      , pn = /[\s,]+/
      , vn = function(t) {
        var n, e, r = new cn;
        return t.split(ln).forEach(function(t) {
            if (t.length) {
                if (void 0 !== fn[t])
                    return void (n = t);
                switch (e = t.split(pn).map(function(t) {
                    return +t || 0
                }),
                n) {
                case "matrix":
      ...
      , gn = 2 * Math.PI
      , xn = function(t, n, e, r, i, a, o, s, h) {
        var u = Math.sin(h * gn / 360)
          , c = Math.cos(h * gn / 360)
          , f = c * (t - e) / 2 + u * (n - r) / 2
          , l = -u * (t - e) / 2 + c * (n - r) / 2;
        if (0 === f && 0 === l)
        ...
        var x = p(t, n, e, r, i, a, o, s, u, c)
          ...
          , d = x[2]
          , m = x[3]
          , M = Math.max(Math.ceil(Math.abs(m) / (gn / 4)), 1);
        m /= M;
        for (var w = 0; w < M; w++)
            y.push(v(d, m)),
            d += m;
    ...
    g.prototype.transform = function(t) {
        var n = Math.cos(this.ax * yn)
          , e = Math.sin(this.ax * yn)
          ...
          , s = (i + a) / 2;
        if (o < 1e-10 * s)
            return this.rx = this.ry = Math.sqrt(s),
            this.ax = 0,
            this;
        ...
        var u = s + o / 2
          , c = s - o / 2;
        return this.ax = Math.abs(h) < 1e-10 && Math.abs(u - a) < 1e-10 ? 90 : 180 * Math.atan(Math.abs(h) > Math.abs(u - a) ? (u - i) / h : h / (u - a)) / Math.PI,
        this.ax >= 0 ? (this.rx = Math.sqrt(u),
        this.ry = Math.sqrt(c)) : (this.ax += 90,
        this.rx = Math.sqrt(c),
        this.ry = Math.sqrt(u)),
        this
    }
    ,
    g.prototype.isDegenerate = function() {
    ...
    x.prototype.__matrix = function(t) {
        ...
        t.queue.length && this.iterate(function(r, i, a, o) {
            ...
            case "v":
                s = t.calc(0, r[1], !0),
                h = 0 === s[0] ? ["v", s[1]] : ["l", s[0], s[1]];
                break;
            case "V":
                s = t.calc(a, r[1], !1),
                h = s[0] === t.calc(a, o, !1)[0] ? ["V", s[1]] : ["L", s[0], s[1]];
                break;
            case "h":
                s = t.calc(r[1], 0, !0),
                h = 0 === s[1] ? ["h", s[0]] : ["l", s[0], s[1]];
                break;
            case "H":
                s = t.calc(r[1], o, !1),
                h = s[1] === t.calc(a, o, !1)[1] ? ["H", s[0]] : ["L", s[0], s[1]];
                break;
            case "a":
            case "A":
                var f = t.toArray()
                  , l = dn(r[1], r[2], r[3]).transform(f);
                if (f[0] * f[3] - f[1] * f[2] < 0 && (r[5] = r[5] ? "0" : "1"),
                s = t.calc(r[6], r[7], "a" === r[0]),
                "A" === r[0] && r[6] === a && r[7] === o || "a" === r[0] && 0 === r[6] && 0 === r[7]) {
                    h = ["a" === r[0] ? "l" : "L", s[0], s[1]];
                    break
                }
    ...
    x.prototype.toString = function() {
        ...
        for (var i = 0; i < this.segments.length; i++)
            n = e.segments[i][0],
            t = i > 0 && "m" !== n && "M" !== n && n === e.segments[i - 1][0],
            r = r.concat(t ? e.segments[i].slice(1) : e.segments[i]);
        return r.join(" ").replace(/ ?([achlmqrstvz]) ?/gi, "$1").replace(/ \-/g, "-").replace(/zm/g, "z m")
    }
    ,
    x.prototype.translate = function(t, n) {
        return this.__stack.push(cn().translate(t, n || 0)),
        this
    }
    ,
    x.prototype.scale = function(t, n) {
        return this.__stack.push(cn().scale(t, n || 0 === n ? n : t)),
        this
    }
    ,
    x.prototype.rotate = function(t, n, e) {
        return this.__stack.push(cn().rotate(t, n || 0, e || 0)),
        this
    }
    ,
    x.prototype.skewX = function(t) {
        return this.__stack.push(cn().skewX(t)),
        this
    }
    ,
    x.prototype.skewY = function(t) {
        return this.__stack.push(cn().skewY(t)),
        this
    }
    ,
    x.prototype.matrix = function(t) {
        return this.__stack.push(cn().matrix(t)),
        this
    }
    ,
    x.prototype.transform = function(t) {
        return t.trim() ? (this.__stack.push(vn(t)),
        this) : this
    }
    ,
    x.prototype.round = function(t) {
        ...
        this.segments.forEach(function(o) {
            ...
            case "a":
                ...
                o[3] = +o[3].toFixed(t + 2),
                o[6] = +o[6].toFixed(t),
                void (o[7] = +o[7].toFixed(t));
            default:
                return n = o.length,
                s && (o[n - 2] += i,
                o[n - 1] += a),
                i = o[n - 2] - o[n - 2].toFixed(t),
                a = o[n - 1] - o[n - 1].toFixed(t),
                void o.forEach(function(n, e) {
                    e && (o[e] = +o[e].toFixed(t))
                })
            }
        }),
    ...
    x.prototype.iterate = function(t, n) {
        ...
        if (n || this.__evaluateStack(),
        a.forEach(function(n, e) {
            var r = t(n, e, h, u);
            Array.isArray(r) && (o[e] = r,
            s = !0);
            ...
            case "Z":
                ...
                void (u = f);
            default:
                h = n[n.length - 2] + (i ? h : 0),
                u = n[n.length - 1] + (i ? u : 0)
            }
        }),
        !s)
            return this;
    ...
    x.prototype.unarc = function() {
        return this.iterate(function(t, n, e, r) {
            var i, a, o, s = [], h = t[0];
            return "A" !== h && "a" !== h ? null : ("a" === h ? (a = e + t[6],
            o = r + t[7]) : (a = t[6],
            o = t[7]),
            i = xn(e, r, a, o, t[4], t[5], t[1], t[2], t[3]),
            0 === i.length ? [["a" === t[0] ? "l" : "L", t[6], t[7]]] : (i.forEach(function(t) {
    ...
    x.prototype.unshort = function() {
        ...
        return this.iterate(function(o, s, h, u) {
            ...
            c || (r += h,
            i += u),
            a[s] = [c ? "q" : "Q", r, i, o[1], o[2]]) : "S" === l && (c = "s" === f,
            e = a[s - 1],
            "C" === e[0] ? (t = e[3] - h,
            n = e[4] - u) : "c" === e[0] ? (t = e[3] - e[5],
            n = e[4] - e[6]) : (t = 0,
            n = 0),
            r = -t,
            i = -n,
    ...
    var mn = x
      ...
      , bn = /([astvzqmhlc])([^astvzqmhlc]*)/gi
      , Ln = function(t) {
        var n = [];
        return t.replace(bn, function(t, e, r) {
            var i = e.toLowerCase();
            for (r = y(r),
            "m" === i && r.length > 2 && (n.push([e].concat(r.splice(0, 2))),
            i = "l",
            e = "m" === e ? "l" : "L"); r.length >= 0; ) {
                if (r.length === wn[i])
                    return r.unshift(e),
                    n.push(r);
                if (r.length < wn[i])
                    throw new Error("malformed path data");
                n.push([e].concat(r.splice(0, wn[i])))
            }
        }),
        n
    }
      , An = /-?[0-9]*\.?[0-9]+(?:e[-+]?\d+)?/gi
      , qn = function(t, n, e, r, i, a, o, s) {
    ...
    d.prototype = {
        ...
        getPropertiesAtLength: function(t) {
            var n, e = w(t, this.length, this.getArcLength, [this.a.x, this.b.x, this.c.x, this.d.x], [this.a.y, this.b.y, this.c.y, this.d.y]), r = this.getDerivative([this.a.x, this.b.x, this.c.x, this.d.x], [this.a.y, this.b.y, this.c.y, this.d.y], e), i = Math.sqrt(r.x * r.x + r.y * r.y);
            n = i > 0 ? {
                x: r.x / i,
                y: r.y / i
            } : {
    ...
    var kn = [[], [], [-.5773502691896257, .5773502691896257], [0, -.7745966692414834, .7745966692414834], [-.33998104358485626, .33998104358485626, -.8611363115940526, .8611363115940526], [0, -.5384693101056831, .5384693101056831, -.906179845938664, .906179845938664], [.6612093864662645, -.6612093864662645, -.2386191860831969, .2386191860831969, -.932469514203152, .932469514203152], [0, .4058451513773972, -.4058451513773972, -.7415311855993945, .7415311855993945, -.9491079123427585, .9491079123427585], [-.1834346424956498, .1834346424956498, -.525532409916329, .525532409916329, -.7966664774136267, .7966664774136267, -.9602898564975363, .9602898564975363], [0, -.8360311073266358, .8360311073266358, -.9681602395076261, .9681602395076261, -.3242534234038089, .3242534234038089, -.6133714327005904, .6133714327005904], [-.14887433898163122, .14887433898163122, -.4333953941292472, .4333953941292472, -.6794095682990244, .6794095682990244, -.8650633666889845, .8650633666889845, -.9739065285171717, .9739065285171717], [0, -.26954315595234496, .26954315595234496, -.5190961292068118, .5190961292068118, -.7301520055740494, .7301520055740494, -.8870625997680953, .8870625997680953, -.978228658146057, .978228658146057], [-.1252334085114689, .1252334085114689, -.3678314989981802, .3678314989981802, -.5873179542866175, .5873179542866175, -.7699026741943047, .7699026741943047, -.9041172563704749, .9041172563704749, -.9815606342467192, .9815606342467192], [0, -.2304583159551348, .2304583159551348, -.44849275103644687, .44849275103644687, -.6423493394403402, .6423493394403402, -.8015780907333099, .8015780907333099, -.9175983992229779, .9175983992229779, -.9841830547185881, .9841830547185881], [-.10805494870734367, .10805494870734367, -.31911236892788974, .31911236892788974, -.5152486363581541, .5152486363581541, -.6872929048116855, .6872929048116855, -.827201315069765, .827201315069765, -.9284348836635735, .9284348836635735, -.9862838086968123, .9862838086968123], [0, -.20119409399743451, .20119409399743451, -.3941513470775634, .3941513470775634, -.5709721726085388, .5709721726085388, -.7244177313601701, .7244177313601701, -.8482065834104272, .8482065834104272, -.937273392400706, .937273392400706, -.9879925180204854, .9879925180204854], [-.09501250983763744, .09501250983763744, -.2816035507792589, .2816035507792589, -.45801677765722737, .45801677765722737, -.6178762444026438, .6178762444026438, -.755404408355003, .755404408355003, -.8656312023878318, .8656312023878318, -.9445750230732326, .9445750230732326, -.9894009349916499, .9894009349916499], [0, -.17848418149584785, .17848418149584785, -.3512317634538763, .3512317634538763, -.5126905370864769, .5126905370864769, -.6576711592166907, .6576711592166907, -.7815140038968014, .7815140038968014, -.8802391537269859, .8802391537269859, -.9506755217687678, .9506755217687678, -.9905754753144174, .9905754753144174], [-.0847750130417353, .0847750130417353, -.2518862256915055, .2518862256915055, -.41175116146284263, .41175116146284263, -.5597708310739475, .5597708310739475, -.6916870430603532, .6916870430603532, -.8037049589725231, .8037049589725231, -.8926024664975557, .8926024664975557, -.9558239495713977, .9558239495713977, -.9915651684209309, .9915651684209309], [0, -.16035864564022537, .16035864564022537, -.31656409996362983, .31656409996362983, -.46457074137596094, .46457074137596094, -.600545304661681, .600545304661681, -.7209661773352294, .7209661773352294, -.8227146565371428, .8227146565371428, -.9031559036148179, .9031559036148179, -.96020815213483, .96020815213483, -.9924068438435844, .9924068438435844], [-.07652652113349734, .07652652113349734, -.22778585114164507, .22778585114164507, -.37370608871541955, .37370608871541955, -.5108670019508271, .5108670019508271, -.636053680726515, .636053680726515, -.7463319064601508, .7463319064601508, -.8391169718222188, .8391169718222188, -.912234428251326, .912234428251326, -.9639719272779138, .9639719272779138, -.9931285991850949, .9931285991850949], [0, -.1455618541608951, .1455618541608951, -.2880213168024011, .2880213168024011, -.4243421202074388, .4243421202074388, -.5516188358872198, .5516188358872198, -.6671388041974123, .6671388041974123, -.7684399634756779, .7684399634756779, -.8533633645833173, .8533633645833173, -.9200993341504008, .9200993341504008, -.9672268385663063, .9672268385663063, -.9937521706203895, .9937521706203895], [-.06973927331972223, .06973927331972223, -.20786042668822127, .20786042668822127, -.34193582089208424, .34193582089208424, -.469355837986757, .469355837986757, -.5876404035069116, .5876404035069116, -.6944872631866827, .6944872631866827, -.7878168059792081, .7878168059792081, -.8658125777203002, .8658125777203002, -.926956772187174, .926956772187174, -.9700604978354287, .9700604978354287, -.9942945854823992, .9942945854823992], [0, -.1332568242984661, .1332568242984661, -.26413568097034495, .26413568097034495, -.3903010380302908, .3903010380302908, -.5095014778460075, .5095014778460075, -.6196098757636461, .6196098757636461, -.7186613631319502, .7186613631319502, -.8048884016188399, .8048884016188399, -.8767523582704416, .8767523582704416, -.9329710868260161, .9329710868260161, -.9725424712181152, .9725424712181152, -.9947693349975522, .9947693349975522], [-.06405689286260563, .06405689286260563, -.1911188674736163, .1911188674736163, -.3150426796961634, .3150426796961634, -.4337935076260451, .4337935076260451, -.5454214713888396, .5454214713888396, -.6480936519369755, .6480936519369755, -.7401241915785544, .7401241915785544, -.820001985973903, .820001985973903, -.8864155270044011, .8864155270044011, -.9382745520027328, .9382745520027328, -.9747285559713095, .9747285559713095, -.9951872199970213, .9951872199970213]]
      ...
      , Sn = function(t, n, e, r, i, a, o, s, h) {
        ...
        p > 1 && (e *= Math.sqrt(p),
        r *= Math.sqrt(p));
        var v = S(t, n, s, h, a, o, e, r, u, c)
          , g = []
          , x = v[2]
          , y = v[3]
          , d = Math.max(Math.ceil(Math.abs(y) / (En / 4)), 1);
        y /= d;
        for (var m = 0; m < d; m++)
            g.push(C(x, y)),
            x += y;
    ...
    var Tn = function(t) {
        function n(t) {
            if (!t)
                return null;
            for (var a, o, s = Ln(t), h = [0, 0], u = [0, 0], c = 0; c < s.length; c++)
                "M" === s[c][0] ? (h = [s[c][1], s[c][2]],
                o = [h[0], h[1]],
                i.push(null)) : "m" === s[c][0] ? (h = [s[c][1] + h[0], s[c][2] + h[1]],
                o = [h[0], h[1]],
                i.push(null)) : "L" === s[c][0] ? (e += Math.sqrt(Math.pow(h[0] - s[c][1], 2) + Math.pow(h[1] - s[c][2], 2)),
                i.push(new Zn(h[0],s[c][1],h[1],s[c][2])),
                h = [s[c][1], s[c][2]]) : "l" === s[c][0] ? (e += Math.sqrt(Math.pow(s[c][1], 2) + Math.pow(s[c][2], 2)),
                i.push(new Zn(h[0],s[c][1] + h[0],h[1],s[c][2] + h[1])),
                h = [s[c][1] + h[0], s[c][2] + h[1]]) : "H" === s[c][0] ? (e += Math.abs(h[0] - s[c][1]),
                i.push(new Zn(h[0],s[c][1],h[1],h[1])),
                h[0] = s[c][1]) : "h" === s[c][0] ? (e += Math.abs(s[c][1]),
                i.push(new Zn(h[0],h[0] + s[c][1],h[1],h[1])),
                h[0] = s[c][1] + h[0]) : "V" === s[c][0] ? (e += Math.abs(h[1] - s[c][1]),
                i.push(new Zn(h[0],h[0],h[1],s[c][1])),
                h[1] = s[c][1]) : "v" === s[c][0] ? (e += Math.abs(s[c][1]),
                i.push(new Zn(h[0],h[0],h[1],h[1] + s[c][1])),
                h[1] = s[c][1] + h[1]) : "z" === s[c][0] || "Z" === s[c][0] ? (e += Math.sqrt(Math.pow(o[0] - h[0], 2) + Math.pow(o[1] - h[1], 2)),
                i.push(new Zn(h[0],o[0],h[1],o[1])),
                h = [o[0], o[1]]) : "C" === s[c][0] ? (a = new qn(h[0],h[1],s[c][1],s[c][2],s[c][3],s[c][4],s[c][5],s[c][6]),
                e += a.getTotalLength(),
                h = [s[c][5], s[c][6]],
                i.push(a)) : "c" === s[c][0] ? (a = new qn(h[0],h[1],h[0] + s[c][1],h[1] + s[c][2],h[0] + s[c][3],h[1] + s[c][4],h[0] + s[c][5],h[1] + s[c][6]),
                e += a.getTotalLength(),
                h = [s[c][5] + h[0], s[c][6] + h[1]],
                i.push(a)) : "S" === s[c][0] ? (a = c > 0 && ["C", "c", "S", "s"].indexOf(s[c - 1][0]) > -1 ? new qn(h[0],h[1],2 * h[0] - s[c - 1][s[c - 1].length - 4],2 * h[1] - s[c - 1][s[c - 1].length - 3],s[c][1],s[c][2],s[c][3],s[c][4]) : new qn(h[0],h[1],h[0],h[1],s[c][1],s[c][2],s[c][3],s[c][4]),
                e += a.getTotalLength(),
                h = [s[c][3], s[c][4]],
                i.push(a)) : "s" === s[c][0] ? (a = c > 0 && ["C", "c", "S", "s"].indexOf(s[c - 1][0]) > -1 ? new qn(h[0],h[1],h[0] + a.d.x - a.c.x,h[1] + a.d.y - a.c.y,h[0] + s[c][1],h[1] + s[c][2],h[0] + s[c][3],h[1] + s[c][4]) : new qn(h[0],h[1],h[0],h[1],h[0] + s[c][1],h[1] + s[c][2],h[0] + s[c][3],h[1] + s[c][4]),
                e += a.getTotalLength(),
                h = [s[c][3] + h[0], s[c][4] + h[1]],
                i.push(a)) : "Q" === s[c][0] ? (a = h[0] != s[c][1] && h[1] != s[c][2] ? new qn(h[0],h[1],s[c][1],s[c][2],s[c][3],s[c][4]) : new Zn(s[c][1],s[c][3],s[c][2],s[c][4]),
                e += a.getTotalLength(),
                i.push(a),
                h = [s[c][3], s[c][4]],
                u = [s[c][1], s[c][2]]) : "q" === s[c][0] ? (a = 0 != s[c][1] || 0 != s[c][2] ? new qn(h[0],h[1],h[0] + s[c][1],h[1] + s[c][2],h[0] + s[c][3],h[1] + s[c][4]) : new Zn(h[0] + s[c][1],h[0] + s[c][3],h[1] + s[c][2],h[1] + s[c][4]),
                e += a.getTotalLength(),
                u = [h[0] + s[c][1], h[1] + s[c][2]],
                h = [s[c][3] + h[0], s[c][4] + h[1]],
                i.push(a)) : "T" === s[c][0] ? (a = c > 0 && ["Q", "q", "T", "t"].indexOf(s[c - 1][0]) > -1 ? new qn(h[0],h[1],2 * h[0] - u[0],2 * h[1] - u[1],s[c][1],s[c][2]) : new Zn(h[0],s[c][1],h[1],s[c][2]),
                i.push(a),
                e += a.getTotalLength(),
                u = [2 * h[0] - u[0], 2 * h[1] - u[1]],
                h = [s[c][1], s[c][2]]) : "t" === s[c][0] ? (a = c > 0 && ["Q", "q", "T", "t"].indexOf(s[c - 1][0]) > -1 ? new qn(h[0],h[1],2 * h[0] - u[0],2 * h[1] - u[1],h[0] + s[c][1],h[1] + s[c][2]) : new Zn(h[0],h[0] + s[c][1],h[1],h[1] + s[c][2]),
                e += a.getTotalLength(),
                u = [2 * h[0] - u[0], 2 * h[1] - u[1]],
                h = [s[c][1] + h[0], s[c][2] + h[0]],
                i.push(a)) : "A" === s[c][0] ? (a = new Cn(h[0],h[1],s[c][1],s[c][2],s[c][3],s[c][4],s[c][5],s[c][6],s[c][7]),
                e += a.getTotalLength(),
                h = [s[c][6], s[c][7]],
                i.push(a)) : "a" === s[c][0] && (a = new Cn(h[0],h[1],s[c][1],s[c][2],s[c][3],s[c][4],s[c][5],h[0] + s[c][6],h[1] + s[c][7]),
                e += a.getTotalLength(),
                h = [h[0] + s[c][6], h[1] + s[c][7]],
                i.push(a)),
                r.push(e);
            return n
        }
      ...
      , Qn = function(t) {
        ...
        for (var s in i)
            for (var h = i[s], u = h.length, c = 0; c < u; ++c)
                for (var f = c + 1; f < u; ++f) {
                    var l, p = h[c], v = h[f];
                    (l = a[p])[s = Nn(l, v)] !== v && l.splice(s, 0, v),
                    (l = a[v])[s = Nn(l, p)] !== p && l.splice(s, 0, p)
                }
        return a
    }
      , Un = function(t, n) {
