function fetchLocation() {
    ...
    var hydrorows = [
        ...
        {
        "name": "Bear River",
        "hydroscope": "The Bear River makes almost a full U-turn, and it is the longest river in North America that doesn't ultimately reach the sea. Don't be discouraged when you feel you are retracing old steps, or not bound for the same destination as others. You are simply on an unconventional path to success.",
        "huc": 16,
        ...
        "hydroscope": "The Colorado River of Texas is home to several man-made lakes and dams, but its mouth is located at Matagorda Bay, a marshy inlet which supports a seaport, ghost town, series of rice fields, and an enormous number of birds, fish, and invertebrates. Whatever you are seeking now, there is fertile ground for it in your future. Be patient and don't force it.",
        "huc": 12,
        "huc_name": "Texas-Gulf Region",
        ...
        {
        "name": "Columbia River",
        "hydroscope": "The Columbia River connects many cultures in the Pacific Northwest, and is home to various species of fish which migrate between fresh and salt water, quite a rare quality in animals. You are more adaptable and social than most, with a tendency to be a bridge between groups and navigate transitions with ease.",
        "huc": 17,
        "huc_name": "Pacific Northwest Region",
        ...
        "hydroscope": "The Connecticut River has been the at the center of centuries of border disputes, between tribes, colonies, states, and eventually even countries. People might fight over their rights to your time and talent. Don't sweat it; carve your own course.",
        "huc": 1,
        "huc_name": "New England Region",
        ...
        {
        "name": "Hoh River",
        "hydroscope": "The Hoh River is fed by glaciers, whose fine sediment lend it a slate blue color in places. You may be inclined toward the occasional bout of the \"blues\", or phases where you feel something is clouding your vision. The Hoh's color returns to normal as it is joined by tributaries. Joining forces with those who are headed in the same direction may help you achieve clarity.",
        "huc": 17,
        "huc_name": "Pacific Northwest Region",
        ...
        {
        "name": "Hudson River",
        "hydroscope": "The Hudson River starts as Feldspar Brook, before it is joined by the Opalescent River, which in turn becomes Calamity Brook. Despite being one of America's most iconic rivers, it is not known by its common name until well along its course. You may be destined to live through a series of identities in this lifetime. Embrace these changes with grace, and if you ever doubt your consistency, know that it is precisely your multifaceted nature that makes you who you are.",
        "huc": 2,
        "huc_name": "Mid Atlantic Region",
        ...
        {
        "name": "Humboldt River",
        "hydroscope": "The Humboldt River is almost 100 miles longer than formal estimates have previously held, because it sports so many twists and turns. There is almost certainly more to you than meets the eye, but don't worry about proving it; it will become obvious in due time.",
        "huc": 16,
        "huc_name": "Great Basin Region",
        ...
        {
        "name": "Jordan River",
        "hydroscope": "The Jordan River is regulated by pumps at its headwaters. Originally a cold-water fishery supporting several native species of fish, the waters have warmed up common carp now rule its waters. The Jordan is a key resource for another group of animals, however, providing food, water, and habitat to the thousands of migrating birds that migrate up and down the flyways of the Great Basin. If one avenue has \"dried up,\" you may need to look in unexpected places––or put in a bit of elbow grease––to find new motivation and community.",
        "huc": 16,
        "huc_name": "Great Basin Region",
        ...
        {
        "name": "Klamath River",
        "hydroscope": "The Klamath River has been called an \"upside down river,\" because unlike most rivers, it begins in the desert and flows through the mountains before reaching the sea. It boasts many of the longest free-flowing stretches of river along the west coast of the United States. Sometimes it will be necessary for you to defy expectations and norms to find your freedom.",
        "huc": 18,
        "huc_name": "California Region",
        ...
        "hydroscope": "Over the years, the Merrimack has supported a great deal of trade and industry. Massachusetts and New Hampshire are working together to add infiltration wells to increase the amount of drinking water that this historically polluted river can provide. Through collaboration, you may be able to rescue something that was once lost.",
        "huc": 1,
        "huc_name": "New England Region",
        ...
        {
        "name": "Missouri River",
        "hydroscope": "The Missouri River is seen as a tributary of the Mississippi, but on its own, it is much longer and carries almost the same amount of water. You may need to learn what to do when others try to take credit for your work, or you feel as though you are living in someone else's shadow. For now, stand tall on your own merit; eventually, you will effortlessly join forces with whatever is troubling you.",
        "huc": 10,
        ...
        {
        "name": "Nueces River",
        "hydroscope": "Beautiful pecan trees line the banks of the Nueces, whose name is Spanish for nuts. Pecans historically symbolize health and wealth, and you will have plenty of both if you can relax and truly accept what the tides of good fortune have to bring.",
        "huc": 12,
        "huc_name": "Texas-Gulf Region",
        ...
        "hydroscope": "The Piscataqua is a tidal river, with its Abenaki name loosely translated to \"branch with strong current.\" You may feel exceptionally sensitive to the rise and fall of the emotions of others or conditions in the world, what some call an \"empath.\" This may feel like a curse at first, but when given proper care and attention, it can become a great superpower. Tune in to what the universal tides are trying to communicate.",
        "huc": 1,
        "huc_name": "New England Region",
        ...
        "hydroscope": "The Presumpscot River Preserve has been protected for twenty years by the State of Maine and the City of Portland. The river also supports hydroelectric power downstream. You're doing a good job protecting something valuable while also staying productive. Way to go!",
        "huc": 1,
        "huc_name": "New England Region",
        ...
        {
        "name": "Rainy River",
        "hydroscope": "The International Game Fish Association All-Tackle world record was set along this river, by a man named Joel Anderson, who caught a white sucker that weighed almost seven pounds. Sometimes you may feel like a big fish in a small pond. You are actually just a pretty big fish overall. Celebrate your accomplishments.",
        "huc": 9,
        ...
        {
        "name": "Red River",
        "hydroscope": "Clay and silt containing iron oxides give the Red River its color––it is almost literally \"rusty.\" If there is an old skill, pleasure, or relationship that has become rusty, it may be a good time to breathe some life back into it.",
        "huc": 11,
        "huc_name": "Arkansas-White-Red Region",
        ...
        "hydroscope": "This river has been enormously prone to flooding, including ancient \"paleofloods\" which have left visible traces of their dramatic effects on local landscapes. Floods symbolize cleansing, and in some Hindu mythology, a deluge signifies a transition into a new epoch, during which deities  try to help humans preserve knowledge for future generations. You may be having an \"Interstellar\" moment: is the future telling you to hold on to some piece of knowledge or wisdom through a great transition?",
        "huc": 9,
        "huc_name": "Souris-Red-Rainy Region",
        ...
        "hydroscope": "This river was originally called \"Masoliantekw\" in Abenaki, meaning \"water where there is plenty of food.\" The Richelieu River has since been the site of many battles among the Iroquois, French, British, and Americans. It may be tempting to fight over resources; remember that conflict arises when we forget that there is enough for everyone.",
        "huc": 4,
        ...
        {
        "name": "Rogue River",
        "hydroscope": "The Rogue River is home to many beaver, an animal that symbolizes hope, collaboration, wealth, wisdom, and success in many cultures. However, when European explorers and settlers began trapping beaver for their pelts along the Rogue, violent conflict ensued.  The reckless pursuit of wealth or comfort might lead to a devastating battle that renders its winnings meaningless. Remember that true success requires collaboration.",
        "huc": 17,
        "huc_name": "Pacific Northwest Region",
        ...
        "hydroscope": "Due to its wide, marshy outlet, animals from the Pacific Ocean have occasionally been found lost in the Sacramento River, such as Humphrey the humpback whale. In 1985, Humphrey made it almost 70 miles up the river before being rescued by scientists who played recordings of humpback whale sounds to lure him back to the sea. If something doesn't feel quite right, you may not be where you belong. Occasionally, you may need to enlist others' help to bring you back to yourself. That's okay; you're an adventurer at heart!",
        "huc": 18,
        "huc_name": "California Region",
        ...
        "hydroscope": "The Saint Lawrence is a tidal river, home to many populations of resident whales, such as belugas, sperm whales, minke whales, fin whales, blue whales, and North Atlantic right whales.  These magnificent animals represent compassion, solitude, and creativity. When in doubt, seek a safe harbor for these ideals to flourish.",
        "huc": 4,
        "huc_name": "Great Lakes Region",
        ...
        {
        "name": "San Joaquin",
        "hydroscope": "The San Joaquin river was once a wide inland sea, and it now supports almost $15 billion worth of crop production in its river basin. Things may look very differently for you now than they once did. Trust the journey.",
        "huc": 18,
        "huc_name": "California Region",
        ...
        {
        "name": "Seekonk River",
        "hydroscope": "The Seekonk River banks are home to phragmites grasses, willow, oak, and beech.  Some consider willow bark the original painkiller, and symbolizes healing and recovery from pain, and the oak is an international emblem of strength and survival. When life hands you lemons, call on the wisdom of the natural world to find your inner strength. Phragmites reeds can be used to make flutes; making music or pursuing another creative hobby can help get you through this challenging time.",
        "huc": 1,
        "huc_name": "New England Region",
        ...
        {
        "name": "Souris River",
        "hydroscope": "The flow of the Souris River varies greatly with the seasons; most of its volume comes from snowmelt and spring showers. You may be prone to relationships, personality traits, or even types of work that change with the seasons. Embracing this about yourself will allow you to find your own rhythm of consistency.",
        "huc": 9,
        "huc_name": "Souris-Red-Rainy Region",
        ...
        {
        "name": "Suwannee River",
        "hydroscope": "Fifty-five springs feed the Suwannee as it winds through the Southeast. It also boasts Florida's only whitewater rapids. You may take inspiration from many sources, and transform it into something striking and magical. Indulge your creative side.",
        "huc": 3,
        "huc_name": "South Atlantic-Gulf Region",
        ...
        {
        "name": "Weber River",
        "hydroscope": "A rare plant species called \"hidden wirelettuce,\" with beautiful bright-pink flowers, is found along––and only along––the Weber River's corridor. You have something special to share with the world. Protect what makes you unique.",
        "huc": 16,
        "huc_name": "Great Basin Region",
        ...
        {
        "name": "White River",
        "hydroscope": "The White River's headwaters are \"fast and furious\" during winter and spring rains, and calm the rest of the year. You may be prone to similarly furious bursts of work, love, or inspiration. Ride these waves with grace, but when the rush is over, don't lose your spark in the rhythm of everyday life.",
        "huc": 11,
        "huc_name": "Arkansas-White-Red Region",
    ...
    //////////////////////////////////
        ...
        function createRiverdivs(this_huc, riversArray) {
            ...
            console.log(filteredHydroscopes, "filter the hydroscope json")

            var html = function(d) { return "<div class='vector flex-pic'></div><h3>" + d.name + "</h3><p>" + d.hydroscope + "</p>"; };
